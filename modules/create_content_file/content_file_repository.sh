...
for CLASS in "${DOMAIN_CLASSES[@]}"; do
  ...
  echo "Creating Repository for $CLASS_NAME"
  ...
  echo "import com.$PROJECT_NAME.app.persistence.entity.${CLASS_NAME};" >> "$REPOSITORY/${CLASS_NAME}Repository.java"
  echo "import org.springframework.data.jpa.repository.JpaRepository;" >> "$REPOSITORY/${CLASS_NAME}Repository.java"
  echo "" >> "$REPOSITORY/${CLASS_NAME}Repository.java"
